          ...
          <div className="border-[4px] border-white p-6 mb-8">
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                ...
                our services. By using TradeDotFun, you represent that you are
                at least 18 years old and capable of forming a binding contract.
              </p>
              <p className="mb-4 text-[10px]">
                These Terms constitute a legally binding agreement between you
                and TradeDotFun regarding your use of our platform and services.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                TradeDotFun provides a trading simulation platform. Our services
