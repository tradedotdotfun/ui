              ...
              <div className="mb-8">
                ...
                <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                  ...
                  <li>
                    ...
                    how you interact with our platform, including trading
                    activities, positions opened/closed, and features you use.
                  </li>
                  <li>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                  ...
                  <li>
                    ...
                    to protect the rights, property, or safety of TradeDotFun,
                    our users, or others.
                  </li>
                  <li>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                  ...
                  <li>
                    ...
                    personal information to authorized employees, contractors,
                    and agents who need that information to operate, develop, or
                  ...
                  <li>
                    <strong>Blockchain Security:</strong> We leverage the
                    inherent security features of blockchain technology for
                ...
                <p className="mb-4 text-[10px]">
                  ...
                  not responsible for unauthorized access, loss, or alteration
                  of your information due to factors beyond our reasonable
                  control.
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                  <li>
                    ...
                    update certain personal information through your account
                    settings.
                  </li>
                  <li>
                    <strong>Deletion:</strong> You can request the deletion of
                    your account and associated personal information by
                    contacting us.
                  </li>
                  <li>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                  ...
                  <li>
                    ...
                    that use cookies to collect information about how visitors
                    use our site.
                  </li>
                </ul>
                <p className="mb-4 text-[10px]">
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                  ...
                  <li>
                    ...
                    not apply to third-party websites. We are not responsible
              ...
              <div>
                ...
                <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                  <li>
                    ...
                    Policy periodically to reflect changes in our practices or
                  ...
                  <li>
                    <strong>Your Continued Use:</strong> Your continued use of
                    our platform after any changes to this Privacy Policy
