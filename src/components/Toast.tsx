...
const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={`fixed top-5 right-5 z-50 w-[500px] border-[4px] border-white px-7 py-5 transition-opacity duration-300 ${
    ...
    >
      <div className="flex justify-between items-start">
        <div className="w-full">
          <h3
            className={`mb-1 text-[16px] text-left font-bold ${
