...

      {
        !isMobile && (
          <>
            ...
            <img src="/pepe-dance.gif" alt="pepe-dance" className="w-[215px] absolute top-[400px] left-[calc(50%-380px)]" />
            <img src="/sonic-dancing.gif" alt="sonic-dancing" className="w-[113px] absolute top-[470px] right-[calc(50%-280px)]" />
          </>
        )
      }
      {
