...
export type TradeDotFun = {
  ...
  instructions: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [118, 97, 117, 108, 116, 95, 100, 97, 116, 97];
              }
            ];
          };
        },
    ...
    },
    {
      ...
      discriminator: [34, 189, 195, 50, 110, 229, 207, 242];
      accounts: [
        {
          name: "user";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [100, 38, 146, 112, 177, 102, 115, 185];
      accounts: [
        {
          name: "vaultData";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [155, 184, 6, 102, 55, 25, 218, 226];
      accounts: [
        {
          name: "user";
          writable: true;
  ...
  accounts: [
    ...
    {
      name: "vaultData";
      discriminator: [130, 212, 101, 247, 146, 181, 149, 100];
    }
  ];
  errors: [
    {
